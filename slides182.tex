...
\begin{frame}
  \begin{center}
    \includegraphics[width=8cm]{hill}
  \end{center}  
\end{frame}

\begin{frame}
  \begin{center}
    \textbf{Visual Classification}
  \end{center}
  \begin{center}
...
\begin{frame}
  \begin{center}
    \includegraphics[width=10cm]{imclass}
  \end{center}  
  \begin{center}
    \href[pdfnewwindow=true]{https://quickdraw.withgoogle.com/}{[Quickdraw]}
  \end{center}
\end{frame}
