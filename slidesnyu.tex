...
\institute[Harvard SEAS]{ \\
  ...
  \begin{center}
    \includegraphics[height=1.5cm]{nyu}
  \end{center}
...
\begin{frame}
  \begin{center}
    \structure{Language Modeling (Shannon, 1948)}
  \end{center}
 ...
 How many guesses needed to predict next word?
...
\begin{frame}
  \centerline{\textbf{OpenNMT}   }

  \begin{itemize}
  \item Open-source machine translation  
    \air 
    [\href[pdfnewwindow=true]{http://opennmt.net/}{http://opennmt.net/}]
 
  \item Successor to seq2seq-attn library.
    \air

  \item Efficient, SoTA implementation of seq2seq.
  \end{itemize}
  \begin{center}
    \includegraphics[width=7cm]{opennmt}
  \end{center}
\end{frame}

\begin{frame}
  \centerline{\textbf{OpenNMT In Practice}   }
...
\begin{frame}
  \centerline{\textbf{Seq2Seq Applications:} \alert{Im2Markup} (Deng et al., 2016) }
...
\begin{frame}
  \begin{center}
    \textbf{\structure{BSO Idea \#1:}} Use a loss that incorporates sequence-level
    costs
  \end{center}
\begin{align*}
...
\begin{frame}[t]
  \begin{center}
    \textbf{\structure{BSO Idea \#2:}} Don't locally normalize
  \end{center}
