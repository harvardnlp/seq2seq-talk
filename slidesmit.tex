...
\begin{frame}{}
  ...
  \item Caption Generation \Cite{karpathy2015deep,Xu2015}
  \item Caption Generation \Cite{Xu2015,Vinyals2015b}
...
\begin{frame}
  \begin{center}
    \movie[width=\textwidth, height=\textheight, poster]{Word
      Vectors}{WordVecs.mp4}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \movie[width=\textwidth, height=4cm, poster, repeat]{\includegraphics[width=\textwidth]{math}}{Latex.mp4}
...
\begin{center}
    \movie[width=5cm, height=0.9\textheight, poster, repeat]{\includegraphics[width=5cm]{phonemt}}{transfast.mp4}
  \end{center}
\end{frame}
