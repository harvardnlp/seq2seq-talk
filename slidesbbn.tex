...
\institute[Harvard SEAS]{ \\
  ...
  \begin{center}
    \includegraphics[height=1.5cm]{RaytheonBBN}
  \end{center}
...
\begin{frame}
  ...
  \begin{itemize}
  \item HarvardNLP's open-source system 
    \air 
    [\href[pdfnewwindow=true]{http://opennmt.github.io/}{http://opennmt.github.io/}]
    \air 
  \item Successor to popular seq2seq-attn library.
    \air

  \item Efficient, SoTA implementation of attention based MT.
  \end{itemize}
  \begin{center}
